...
public class SettingsAsset : ScriptableObject {
	...
	public void SetDefaultSave() {
		serializable.data.player.currency = 0;
		serializable.data.player.maxHP = 100;
		serializable.data.player.currentHP = 100;
		serializable.data.enemyStatictics.sizeOfEnemyKilled = 0;
	}
